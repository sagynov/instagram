...
@section('content')
    <div class="container">
    <form action="/profile/{{ $user->id }}" method="post" enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row">
                    <label class="form-label col-md-4" for="image">Profile Image</label>
                ...
                <div class="row">
                    <button class="mt-4 btn btn-primary">Save Profile</button>
                </div>
            </div>
        </div>
        </form>
